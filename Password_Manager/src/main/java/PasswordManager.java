...
class PasswordManager implements ActionListener {
    ...
    // Old line using in-memory structure:
   // data = new HashtablePassword(15, 0.5F, 0);

// ✅ New line using MySQL:
//    HashtablePassword data = new JDBCHashtable();
//
//    // Old line using in-memory structure:
//    data = new HashtablePassword(15, 0.5F, 0);

// ✅ New line using MySQL:
    JDBCHashtable data = new JDBCHashtable();
